...
def read_midi(filepath):
    ...
    for msg in midi.play():
        if msg.type == 'note_on':  # This means a note is pressed
            print(f"Note {NOTENAMES.get(msg.note, 'Unknown')} pressed")

if __name__ == "__main__":
    midi_file = r'C:\Users\mrh3h\Downloads\Queen - Bohemian Rhapsody.mid'  # This path will be different depending on computer directory and name
    read_midi(midi_file)
